...
![Модель работы аэропорта](image/3.PNG){#fig:004 width=70%}
...
![Отчёт по модели работы аэропорта](image/4.PNG){#fig:005 width=70%}
...
![Модель работы морского порта](image/5.PNG){#fig:007 width=70%}

После запуска симуляции получаем отчёт (рис. [-@fig:008]).

![Отчет по модели работы морского порта](image/6.PNG){#fig:008 width=70%}
...
![Модель работы морского порта с оптимальным количеством причалов](image/7.PNG){#fig:009 width=70%}

![Отчет по модели работы морского порта с оптимальным количеством причалов](image/8.PNG){#fig:010 width=70%}
...
![Отчет по модели работы морского порта](image/12.PNG){#fig:012 width=70%}
...
![Модель работы морского порта с оптимальным количеством причалов](image/13.PNG){#fig:013 width=70%}

![Отчет по модели работы морского порта с оптимальным количеством причалов](image/14.PNG){#fig:014 width=70%}
